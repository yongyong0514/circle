...
<body>
	<div class="menuBox">
		...
		<div class="buttonArea">
			...
			<div><button class="buttonSize" onclick="location='${pageContext.request.contextPath}/poll/pollMain?url=Home'"><img src="${pageContext.request.contextPath}/resources/img/common/menu/121-paste.png" class="menuIcon"><br>설문</button></div>

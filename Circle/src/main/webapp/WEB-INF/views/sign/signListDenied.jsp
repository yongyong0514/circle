		...
		<div class="container">
			...
			<div class="content">
			 ...
			 <div class="paging-area" align="center">
					<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListDenied?currentPages=1'"><<</button>
						...
						<c:if test="${ pi.currentPage > 1 }">
							<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListDenied?currentPages=<c:out value="${ pi.currentPage - 1 }"/>'"><</button>
						</c:if>
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }" step="1">
							...
							<c:if test="${ pi.currentPage ne p }">
								<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListDenied?currentPages=<c:out value="${ p }"/>'"><c:out value="${ p }"/></button>
							</c:if>
						</c:forEach>
						...
						<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListDenied?currentPages=<c:out value="${ pi.maxPage }"/>'">>></button>
				</div>
		</div>
	</div>

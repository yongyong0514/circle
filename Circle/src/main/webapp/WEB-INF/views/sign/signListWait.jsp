		...
		<div class="container">
			<div class="contentBar">
				...
				<div class="signHomeListBar">
					<ul>
						<li class="signHomeListTitle"><img src="${pageContext.request.contextPath}/resources/img/sign/document.png" class="signHomeListTitleImg">나의 대기 결재 목록</li>
			...
			<div class="content">
			 ...
			 <div class="paging-area" align="center">
					<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListWait?currentPages=1'"><<</button>
						...
						<c:if test="${ pi.currentPage > 1 }">
							<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListWait?currentPages=<c:out value="${ pi.currentPage - 1 }"/>'"><</button>
						</c:if>
						...
						<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }" step="1">
							...
							<c:if test="${ pi.currentPage ne p }">
								<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListWait?currentPages=<c:out value="${ p }"/>'"><c:out value="${ p }"/></button>
							</c:if>
						</c:forEach>
						...
						<button id="paging" onclick="location.href='${pageContext.request.contextPath}/sign/signListWait?currentPages=<c:out value="${ pi.maxPage }"/>'">>></button>
				</div>
		</div>
	</div>

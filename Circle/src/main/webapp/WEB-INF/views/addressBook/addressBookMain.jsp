...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/addressBook/addressLeftNav.css">
	...
	<div class="wrap">
		...
		<div class="container">
			...
			<div class="content">
				...
				<!-- 주소록 이름 -->
				<h1>전사주소록(* 나중에 주소록 이름 불러오기)</h1>
				<button value="alertAll">이 그룹에게 전체쪽지 보내기</button>
				<br><br>
				<form class="searchAddress">
					<!-- 검색창 시작 -->
					<input class="searchBox" type="text" name="name" placeholder="이름(표시명)"/>
					<input class="searchBox" type="text" name="email" placeholder="이메일 주소"/>
					<input class="searchBox" type="text" name="tel" placeholder="휴대전화번호"/>

...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/attendance/attendanceMyVacation.css">
</head>
<body>
	<div class="wrap">
		<div class="header">
				...
				<div class="summary">
					...
					<table class="summaryTable">
						<tr>
							...
							<th>총 연차</th>
							<th>지급연차</th>
							<th>지급월차</th>	<!-- 1년 미만은 근무개월수*2 월차 발생 -->
							<th>사용연차</th>
							<th>잔여연차</th>
						</tr>
						<!-- 값 불러오기 -->
						...
						<table class="vacationApplyTable">
							...
							<tr>
								...
								<td>
									...
									(일수: <input id="calcDate" type="text" value="1" readonly/>)
									<!-- 일수는 바로 계산 -->
								</td>
								<td>전자결제상태</td>
								<td><input type="text" id="permissionStatus" name="permission" readonly value="결제대기"></td>
								<td>실제사용여부</td>

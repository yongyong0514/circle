			...
			<div class="content">
				...
				<div class="wrapper">
					<div class="links">
						...
						<br><br>
						<ul>
						<li data-viw="search" class="li-search"
								class="right fa-th-search"></i>Search : <input type="search"></li>
							<li data-viw="search" class="li-sort"
								class="right fa-th-sort"></i>Sort</li>
						</ul>
					</div>
					<div class="view_main">
...
<div class="view_item">
	...
	<script href="${pageContext.request.contextPath}/resources/js/post/postMain.js"></script>

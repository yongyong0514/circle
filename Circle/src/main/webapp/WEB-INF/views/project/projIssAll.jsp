				...
				<table class="projParts">
					<thead>
						<tr>
							...
							<th class="iss_title" scope="cols" style="width: 35%;">업무명</th>
							<th class="emp_info_name" scope="cols" style="width: 35%;">프로젝트명</th>
							<th class="prog_title" scope="cols" style="width: 10%;">업무
								진행단계</th>
							<th class="situ_title" scope="cols" style="width: 10%;">업무
								상황</th>
						</tr>
					</thead>
					<c:forEach var="projissAll" items="${projissAll}">
						<tbody>
							...
							<tr>
								<td scope="row">${projissAll.iss_code}</td>

...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/project/projAdd.css">
<link rel="stylesheet"
...
<body>
	...
	<div class="wrap">
					...
					<div class="input-fields">
						...
						<div class="radio-group">
							...
							<label class="radio"> <input type="radio" value="open"
								name="proj_sec"> 공개 <span></span>
							</label> <label class="radio"> <input type="radio" value="close"
								name="proj_sec"> 비공개 <span></span>
							</label>
						</div>
						<br>
						<br>
		...
		<script src="<c:url value="/resources/js/project/projAdd.js" />"></script>
</body>
</html>